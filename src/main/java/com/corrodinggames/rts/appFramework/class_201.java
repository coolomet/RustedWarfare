...
// $FF: renamed from: com.corrodinggames.rts.appFramework.j
public strictfp class class_201 extends class_194 {
    String[] c;
    ...
    public static String[] l() {
        String[] var0 = class_697.a("/SD/rustedWarfare/saves/", false);
        if (var0 == null) {
            return null;
        } else {
            ...
            Collections.sort(var1, new class_214());
